            ...
            if player.id == id:
                ...
                if d1 < d2:
                    ...
                    for x in range(int(cx), int(cx1)):
                        yi = int(m * x + c)
                        if (int(x / G_WIDTH) > len(grid) - 4 or int(yi / G_WIDTH) > len(grid[0]) - 4 or int(
                                yi / G_WIDTH) < 4 or int(x / G_WIDTH) < 4):
                            continue
                        else:
                    ...
                    for y in range(int(cy), int(cy1)):
                        xi = int((y - c) / m)
                        if (int(xi / G_WIDTH) > len(grid) - 4 or int(y / G_WIDTH) > len(grid[0]) - 4 or int(
                                xi / G_WIDTH) < 4 or int(y / G_WIDTH) < 4):
                            continue
                        else:
